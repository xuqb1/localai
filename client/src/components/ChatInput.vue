    ...
    <div class="bg-slate-800 rounded-2xl p-4 flex-1 flex flex-col">
      ...
      <div class="flex items-center justify-between mt-3 pt-3 border-t border-slate-700">
        ...
        <button
          ...
          class="flex items-center gap-2 px-6 py-2 bg-slate-700 hover:bg-slate-600 disabled:bg-slate-800 disabled:cursor-not-allowed text-white rounded-lg transition-all"
        >
